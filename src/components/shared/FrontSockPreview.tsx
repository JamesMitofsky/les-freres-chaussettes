...
const FrontSockPreview: React.ForwardRefRenderFunction<
  HTMLDivElement,
  { data: FrontSockPreviewInput }
> = ({ data }) => (
  <div className="flex flex-col items-center gap-3" style={sockPrintDimensions}>
    <img
      style={{ top: '8cm', position: 'relative', width: '5.5cm' }}
      src={data.logo_url}
...
export default forwardRef<HTMLDivElement, { data: FrontSockPreviewInput }>(
  FrontSockPreview,
);
